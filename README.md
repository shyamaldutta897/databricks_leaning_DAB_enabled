...
The 'dbx_learning_dab' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/dbx_learning_dab/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dbx_learning_dab_etl` to your workspace.
