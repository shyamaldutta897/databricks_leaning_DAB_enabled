...
df=spark\
    ...
    .table('skd_personal_bronze.new_schema.sensor_logs')
...
# MAGIC %sql
# MAGIC SELECT * FROM skd_personal_bronze.new_schema.sensor_logs TIMESTAMP AS OF '2026-06-15 14:12:49'
...
df=spark\
    .read\
    .format('delta')\
    .option('timestampAsOf','2026-06-15 14:13:49')\
    .table('skd_personal_bronze.new_schema.sensor_logs')
...
# MAGIC %sql
# MAGIC RESTORE TABLE skd_personal_bronze.new_schema.sensor_logs VERSION AS OF 1
...
delta_df=DeltaTable.forName(spark, 'skd_personal_bronze.new_schema.sensor_logs')
delta_df.restoreToVersion(2)
...
# MAGIC %fs ls abfss://bronze@stgsdpersonaldev.dfs.core.windows.net/external_new/sensor_logs/_delta_log

# COMMAND ----------

json_path='abfss://bronze@stgsdpersonaldev.dfs.core.windows.net/external_new/sensor_logs/_delta_log/00000000000000000005.json'
...
json_path='abfss://bronze@stgsdpersonaldev.dfs.core.windows.net/external_new/sensor_logs/_delta_log/00000000000000000006.json'
