...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS skd_personal_ronze.new_schema.emp_records_dclone;
# MAGIC
# MAGIC CREATE OR REPLACE TABLE
# MAGIC skd_personal_bronze.new_schema.emp_records_dclone 
# MAGIC DEEP CLONE skd_personal_bronze.new_schema.employee_records

# COMMAND ----------

# MAGIC %sql
# MAGIC DESCRIBE HISTORY skd_personal_bronze.new_schema.emp_records_dclone 

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM skd_personal_bronze.new_schema.emp_records_dclone 

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT DISTINCT _metadata.file_path from skd_personal_bronze.new_schema.emp_records_dclone
...
# MAGIC %sql
# MAGIC SELECT * FROM skd_personal_bronze.new_schema.employee_records where emp_id=115

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM skd_personal_bronze.new_schema.emp_records_dclone where emp_id=115
...
# MAGIC %sql
# MAGIC INSERT INTO skd_personal_bronze.new_schema.emp_records_dclone VALUES 
...
# MAGIC %sql
# MAGIC SELECT * FROM skd_personal_bronze.new_schema.emp_records_dclone WHERE emp_id=116
