...
The 'dbx_bundle_cli_deployment' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/dbx_bundle_cli_deployment/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dbx_bundle_cli_deployment_etl` to your workspace.
